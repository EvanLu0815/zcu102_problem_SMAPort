...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L gtwizard_ultrascale_v1_7_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gtwizard_ultrascale_0 xil_defaultlib.gtwizard_ultrascale_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gtwizard_ultrascale_0 -key {Behavioral:sim_1:Functional:gtwizard_ultrascale_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
