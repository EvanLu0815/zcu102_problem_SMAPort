...
HD_PWD='E:/Research/Ethernet1G/zcu102_v2_egdesign/gig_ethernet_pcs_pma_0_ex/gig_ethernet_pcs_pma_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MDIO_demo_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MDIO_demo_tb.tcl -notrace
